...
static final long serialVersionUID=7421661901153687490L;
    ...
    public SystemMasterManagedObject() throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
        }
        for(CompareMessage[] permission: HSystem.getDefaultPermission(SystemMasterManagedObject.class))
        {
            addPermission(permission, null, this);
        }
    }
    ...
    public SystemMasterManagedObject(ManagedObject creator, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    protected Object addSystem(ManagedObject masterMOLink, byte[] publicKey, int localPort, InetAddress[] localIPv4s, int port, InetAddress IPv4, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        if(mOAttributes==null && getFirstLatticeManagedObject()!=null)
        {
            return ((SystemMasterManagedObject)getFirstLatticeManagedObject()).addSystem(masterMOLink, publicKey, localPort, localIPv4s, port, IPv4, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
        }
        else
        {
...
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483647, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483647,masterMOLink,publicKey,localPort,localIPv4s,port,IPv4}, null, false}, 1, -2146483635, true, true, new Object[]{IPv4,port,localIPv4s,localPort,publicKey,masterMOLink}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
                    $_MANAGED_object_COMPILER_RETURN_VALUE_$=intelligence(new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483647,masterMOLink,publicKey,localPort,localIPv4s,port,IPv4}, null, false, $_MANAGED_object_COMPILER_CALL_DATA_$, this);
;                    return null;
                }
                if($_MANAGED_object_COMPILER_RETURN_VALUE_$ instanceof TimeOutObject)
                {
...
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483647, "latticeNodes"}, 1, -2146483638, true, true, new Object[]{$_MANAGED_object_COMPILER_SEARCH_RESULT_0_$,$_MANAGED_object_COMPILER_DATA_CONCURRENT_0_$,$_MANAGED_object_COMPILER_INTELLIGENCE_MESSAGE_$,IPv4,port,localIPv4s,localPort,publicKey,masterMOLink}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
                    masterMOLink.getVariable("latticeNodes", $_MANAGED_object_COMPILER_CALL_DATA_$, this);
;                    return null;
                }
                if($_MANAGED_object_COMPILER_RETURN_VALUE_$ instanceof TimeOutObject)
                {
...
List<Node> sysMONodes=(ArrayList<Node>)((Object)$_MANAGED_object_COMPILER_RETURN_VALUE_$);
                for(int nodeNum=0; nodeNum<sysMONodes.size() && nodeNum<HSystem.numInitCheckNodes; nodeNum++)
                {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_1_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
                    ...
                    ((MOThread)$_MANAGED_object_COMPILER_SEARCH_RESULT_1_$[0].mO).addToRun(new Object[]{$_MANAGED_object_COMPILER_DATA_CONCURRENT_1_$, this,$_MANAGED_object_COMPILER_SEARCH_RESULT_1_$, null, new Object[]{$_MANAGED_object_COMPILER_DATA_CONCURRENT_1_$, this, this, -2146483643,nodeNum,sysMONodes,$_MANAGED_object_COMPILER_SEARCH_RESULT_0_$,$_MANAGED_object_COMPILER_DATA_CONCURRENT_0_$,IPv4,port,localIPv4s,localPort,publicKey,masterMOLink}}, $_MANAGED_object_COMPILER_DATA_$, this);
                }
                if(true)
                {
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483647, "latticeNodesMOAttributes"}, 1, -2146483637, true, true, new Object[]{sysMONodes,$_MANAGED_object_COMPILER_SEARCH_RESULT_0_$,$_MANAGED_object_COMPILER_DATA_CONCURRENT_0_$,$_MANAGED_object_COMPILER_INTELLIGENCE_MESSAGE_$,IPv4,port,localIPv4s,localPort,publicKey,masterMOLink}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
                    masterMOLink.getVariable("latticeNodesMOAttributes", $_MANAGED_object_COMPILER_CALL_DATA_$, this);
;                    return null;
                }
                if($_MANAGED_object_COMPILER_RETURN_VALUE_$ instanceof TimeOutObject)
                {
...
MessageDigest sha256=null;
                ...
                {
                    Logger.getLogger(SystemMasterManagedObject.class.getName()).log(Level.SEVERE, null, e);
                }
byte[] oID=sha256.digest(publicKey);
                sha256.reset();
...
int[] SIDMOWeights=new int[SIDMOAttrs.length];
                for(int attrNum=0; attrNum<SIDMOAttrs.length; attrNum++)
                {
                    ...
                    {
                        System.arraycopy(oID, 4*(attrNum-HSystem.mOAttributesLength-1), tempBy, 0, tempBy.length);
                        SIDMOAttrs[attrNum]=ManagedObjectUtilities.b8ToB10Int(tempBy);
                        minSIDMOVals[attrNum]=SIDMOAttrs[attrNum];
                        maxSIDMOVals[attrNum]=SIDMOAttrs[attrNum];
                        SIDMOWeights[attrNum]=HSystem.intMaxValue;
...
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483647,SIDMOAttrs,minSIDMOVals,maxSIDMOVals,SIDMOWeights, 1,HSystem.numInitCheckNodes, false}, 1, -2146483634, true, true, new Object[]{SIDMOWeights,maxSIDMOVals,minSIDMOVals,SIDMOAttrs,tempBy,oID,sha256,sysMONodes,$_MANAGED_object_COMPILER_SEARCH_RESULT_0_$,$_MANAGED_object_COMPILER_DATA_CONCURRENT_0_$,$_MANAGED_object_COMPILER_INTELLIGENCE_MESSAGE_$,IPv4,port,localIPv4s,localPort,publicKey,masterMOLink}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
                    $_MANAGED_object_COMPILER_RETURN_VALUE_$=latticeSearch(SIDMOAttrs, minSIDMOVals, maxSIDMOVals, SIDMOWeights, 1, HSystem.numInitCheckNodes, false, $_MANAGED_object_COMPILER_CALL_DATA_$, this);
;                    return null;
                }
                if($_MANAGED_object_COMPILER_RETURN_VALUE_$ instanceof TimeOutObject)
                {
...
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483647, this,publicKey,port,IPv4,localPort,localIPv4s}, 1, -2146483632, true, true, new Object[]{SID,SIDMOWeights,maxSIDMOVals,minSIDMOVals,SIDMOAttrs,tempBy,oID,sha256,sysMONodes,$_MANAGED_object_COMPILER_SEARCH_RESULT_0_$,$_MANAGED_object_COMPILER_DATA_CONCURRENT_0_$,$_MANAGED_object_COMPILER_INTELLIGENCE_MESSAGE_$,IPv4,port,localIPv4s,localPort,publicKey,masterMOLink}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
                        SIDMO.$_MANAGED_object_COMPILER_CREATE_METHOD_$(this, publicKey, port, IPv4, localPort, localIPv4s, $_MANAGED_object_COMPILER_CALL_DATA_$, this);
;                        return null;
                    }
                    if($_MANAGED_object_COMPILER_RETURN_VALUE_$ instanceof TimeOutObject)
                    {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    @MOCompilerControl(checkLink=false, checkShell=false, compile=false, checkCloned=false, checkPermission=false, intelligenceBefore=false, intelligenceAfter=false, aggregateReturn=false, timeEfficiency=false, offload=false)
    @$_MANAGED_OBJECT_COMPILER_ANNOTATION_$($_SEND_STOPPED_$=false, $_MANAGED_object_COMPILER_RUN_Number_$=2147483647)
    private SystemMasterManagedObject($_MANAGED_object_COMPILER_DUMMY_VARIABLE_$ $_MANAGED_object_COMPILER_DUMMY_variable_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
    ...
    {
SystemMasterManagedObject $_MANAGED_object_COMPILER_CREATED_Object_$=new SystemMasterManagedObject(new $_MANAGED_object_COMPILER_DUMMY_VARIABLE_$());
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
...
;
    ...
    public SystemMasterManagedObject $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$(ManagedObject creator, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(SystemMasterManagedObject.class))
        {
            addPermission(permission, null, this);
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object $_MANAGED_object_COMPILER_CONCURRENT_METHOD_addSystem_0_$(InetAddress IPv4, int port, InetAddress[] localIPv4s, int localPort, byte[] publicKey, ManagedObject masterMOLink, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
...
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483644,masterMOLink}, 1, -2146483641, true, true, new Object[]{masterMOLink,publicKey,localPort,localIPv4s,port,IPv4}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
            integrate(masterMOLink, $_MANAGED_object_COMPILER_CALL_DATA_$, this);
;            return null;
        }
        if($_MANAGED_object_COMPILER_RETURN_VALUE_$ instanceof TimeOutObject)
        {
...
Object $_MANAGED_object_COMPILER_RETURN_VALUE_$=null;
        ...
        if(true)
        {
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483643,sysMONodes.get(nodeNum).mO}, 1, -2146483640, true, true, new Object[]{masterMOLink,publicKey,localPort,localIPv4s,port,IPv4,$_MANAGED_object_COMPILER_DATA_CONCURRENT_0_$,$_MANAGED_object_COMPILER_SEARCH_RESULT_0_$,sysMONodes,nodeNum}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
            integrate(sysMONodes.get(nodeNum).mO, $_MANAGED_object_COMPILER_CALL_DATA_$, this);
;            return null;
        }
        if($_MANAGED_object_COMPILER_RETURN_VALUE_$ instanceof TimeOutObject)
        {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object $_MANAGED_object_COMPILER_CONCURRENT_METHOD_addSystem_2_$(int nodeNum, List<Node> sysMONodes, Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_0_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_CONCURRENT_0_$, InetAddress IPv4, int port, InetAddress[] localIPv4s, int localPort, byte[] publicKey, ManagedObject masterMOLink, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
...
Object $_MANAGED_object_COMPILER_RETURN_VALUE_$=null;
        ...
        if(true)
        {
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483642,sysMONodes.get(nodeNum).mO}, 1, -2146483639, true, true, new Object[]{masterMOLink,publicKey,localPort,localIPv4s,port,IPv4,$_MANAGED_object_COMPILER_DATA_CONCURRENT_0_$,$_MANAGED_object_COMPILER_SEARCH_RESULT_0_$,sysMONodes,nodeNum}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
            integrate(sysMONodes.get(nodeNum).mO, $_MANAGED_object_COMPILER_CALL_DATA_$, this);
;            return null;
        }
        if($_MANAGED_object_COMPILER_RETURN_VALUE_$ instanceof TimeOutObject)
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object $_MANAGED_object_COMPILER_CONCURRENT_METHOD_addSystem_1_$_MANAGED_object_COMPILER_METHOD_11(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
$_MANAGED_object_COMPILER_DATA_$.setRunNumber(-2146483643);
        $_MANAGED_object_COMPILER_RETURN_VALUE_$=ManagedObjectUtilities.messAgree((Object[])$_MANAGED_object_COMPILER_RETURN_VALUE_$);
boolean $_MANAGED_object_COMPILER_FIRST_LOOP_$=true;
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object $_MANAGED_object_COMPILER_CONCURRENT_METHOD_addSystem_2_$_MANAGED_object_COMPILER_METHOD_12(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
$_MANAGED_object_COMPILER_DATA_$.setRunNumber(-2146483642);
        $_MANAGED_object_COMPILER_RETURN_VALUE_$=ManagedObjectUtilities.messAgree((Object[])$_MANAGED_object_COMPILER_RETURN_VALUE_$);
boolean $_MANAGED_object_COMPILER_FIRST_LOOP_$=true;
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object addSystem_MANAGED_object_COMPILER_METHOD_34(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        if(mOAttributes==null && getFirstLatticeManagedObject()!=null)
        {
            return ((SystemMasterManagedObject)getFirstLatticeManagedObject()).addSystem_MANAGED_object_COMPILER_METHOD_34($_MANAGED_object_COMPILER_RETURN_VALUE_$, $_MANAGED_object_COMPILER_RETURN_STATE_$, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
        }
        else
        {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object addSystem_MANAGED_object_COMPILER_METHOD_35(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        if(mOAttributes==null && getFirstLatticeManagedObject()!=null)
        {
            return ((SystemMasterManagedObject)getFirstLatticeManagedObject()).addSystem_MANAGED_object_COMPILER_METHOD_35($_MANAGED_object_COMPILER_RETURN_VALUE_$, $_MANAGED_object_COMPILER_RETURN_STATE_$, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
        }
        else
        {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private void SystemMasterManagedObject_MANAGED_object_COMPILER_METHOD_82(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object addSystem_MANAGED_object_COMPILER_METHOD_83(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        if(mOAttributes==null && getFirstLatticeManagedObject()!=null)
        {
            return ((SystemMasterManagedObject)getFirstLatticeManagedObject()).addSystem_MANAGED_object_COMPILER_METHOD_83($_MANAGED_object_COMPILER_RETURN_VALUE_$, $_MANAGED_object_COMPILER_RETURN_STATE_$, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
        }
        else
        {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object addSystem_MANAGED_object_COMPILER_METHOD_163(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        if(mOAttributes==null && getFirstLatticeManagedObject()!=null)
        {
            return ((SystemMasterManagedObject)getFirstLatticeManagedObject()).addSystem_MANAGED_object_COMPILER_METHOD_163($_MANAGED_object_COMPILER_RETURN_VALUE_$, $_MANAGED_object_COMPILER_RETURN_STATE_$, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
        }
        else
        {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_323(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object addSystem_MANAGED_object_COMPILER_METHOD_336(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        if(mOAttributes==null && getFirstLatticeManagedObject()!=null)
        {
            return ((SystemMasterManagedObject)getFirstLatticeManagedObject()).addSystem_MANAGED_object_COMPILER_METHOD_336($_MANAGED_object_COMPILER_RETURN_VALUE_$, $_MANAGED_object_COMPILER_RETURN_STATE_$, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
        }
        else
        {
...
public static final int $_MANAGED_object_COMPILER_$_MANAGED_object_COMPILER_CONCURRENT_METHOD_addSystem_2_$_int_List__Node___Node$$_ByteArrayWrapper_InetAddress_int_InetAddress$$_int_byte$$_ManagedObject_ByteArrayWrapper_ManagedObject_$=-2146483642;
    ...
    public void MANAGED_object_COMPILER_RUN(Object[] message, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws Exception, MOPermissionDeniedException, TimeOutException
    {
        ...
        {
            case -2146483647:
                addSystem((ManagedObject)message[4], (byte[])message[5], (int)message[6], (InetAddress[])message[7], (int)message[8], (InetAddress)message[9], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483646:
            ...
            case -2146483645:
                ...
                break;
            case -2146483644:
                $_MANAGED_object_COMPILER_CONCURRENT_METHOD_addSystem_0_$((InetAddress)message[4], (int)message[5], (InetAddress[])message[6], (int)message[7], (byte[])message[8], (ManagedObject)message[9], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483643:
                $_MANAGED_object_COMPILER_CONCURRENT_METHOD_addSystem_1_$((int)message[4], (List<Node>)message[5], (Node[])message[6], (ByteArrayWrapper)message[7], (InetAddress)message[8], (int)message[9], (InetAddress[])message[10], (int)message[11], (byte[])message[12], (ManagedObject)message[13], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483642:
                $_MANAGED_object_COMPILER_CONCURRENT_METHOD_addSystem_2_$((int)message[4], (List<Node>)message[5], (Node[])message[6], (ByteArrayWrapper)message[7], (InetAddress)message[8], (int)message[9], (InetAddress[])message[10], (int)message[11], (byte[])message[12], (ManagedObject)message[13], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483641:
                $_MANAGED_object_COMPILER_CONCURRENT_METHOD_addSystem_0_$_MANAGED_object_COMPILER_METHOD_10((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483640:
                $_MANAGED_object_COMPILER_CONCURRENT_METHOD_addSystem_1_$_MANAGED_object_COMPILER_METHOD_11((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483639:
                $_MANAGED_object_COMPILER_CONCURRENT_METHOD_addSystem_2_$_MANAGED_object_COMPILER_METHOD_12((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483638:
                addSystem_MANAGED_object_COMPILER_METHOD_34((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483637:
                addSystem_MANAGED_object_COMPILER_METHOD_35((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483636:
                SystemMasterManagedObject_MANAGED_object_COMPILER_METHOD_82((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483635:
                addSystem_MANAGED_object_COMPILER_METHOD_83((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483634:
                addSystem_MANAGED_object_COMPILER_METHOD_163((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483633:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_323((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483632:
                addSystem_MANAGED_object_COMPILER_METHOD_336((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            default:
