...
protected int transmitNum=10000;
...
Node[] mOThread=latticeSearchLocalMOThread(1, HSystem.defaultNumCheckNodes, getSID(), $_MANAGED_object_COMPILER_DATA_$, this);
                    ...
                    else
                    {
                        ...
                        {
                            Collections.shuffle(toTransmit, new Random());
Object[] toSendMessage=null;
Node[] dataTransferManagedObject=latticeSearchLocal(dataTransferMOAttr, dataTransferMinimumMOAttr, dataTransferMaximumMOAttr, dataTransferWeights, 1, HSystem.defaultNumCheckNodes, false, $_MANAGED_object_COMPILER_DATA_$, this);
                            if(dataTransferManagedObject.length>0)
                            {
                                for(int messageNumber=0; messageNumber<toTransmit.size() && messageNumber<transmitNum; messageNumber++)
                                {
                                    toSendMessage=toTransmit.get(messageNumber);
                                    toSendMessage[2]=(UDPManagedObject)dataTransferManagedObject[0].mO;
                                    ((UDPManagedObject)dataTransferManagedObject[0].mO).send(toSendMessage, $_MANAGED_object_COMPILER_DATA_$, this);
...
Object $_MANAGED_object_COMPILER_RETURN_VALUE_$=null;
        ...
        if(true)
        {
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483627,creator}, 1, -2146483610, true, true, new Object[]{protocolStrength,securityProtocol,oSID,creator,dataCompression,lastReceivedTime,sendState,receiveState,receiveAttempts,sendAttempts,maxCommunicationAttempts,oPublicKey,lastMessageReceived,receivedPackets,dataTransferWeights,dataTransferMaximumMOAttr,dataTransferMinimumMOAttr,dataTransferMOAttr,recievingCommWeights,recievingCommMOMaxAttr,recievingCommMOMinAttr,recievingCommMOAttr,maxTransmitBytes,transmitNum,maxTransmitSize,receiveConMessNumSend,sendConMessNumSend,receiveConMessNumReceive,sendConMessNumReceive,confirmReceiveNum,confirmSendNum,confirmReceiveOut,confirmSendOut,iLength,complete,senderMess,toTransmit,cAlgs,toSend,transmitting,received,cInit,rLength,recveing,receivedMessageBlock,receivedMessageBlocks,dCAlg,key,oPort,lastConTime,sRNumber,receiveNumber,prevReceiveNumber,prevSendNumber,sendNumber,numNeeded,oID,oIP,commSec}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
...
Node[] SIDMO=((Node[])$_MANAGED_object_COMPILER_RETURN_VALUE_$);
            if(true)
            {
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483627,HSystem.masterIP}, 1, -2146483611, true, true, new Object[]{SIDMO,SIDMOWeights,maxSIDMOVals,minSIDMOVals,SIDMOAttrs,matchingCommMOAttributesWeights,matchingCommMOAttributes,tempBy,commAttrs,protocolStrength,securityProtocol,oSID,creator,dataCompression,lastReceivedTime,sendState,receiveState,receiveAttempts,sendAttempts,maxCommunicationAttempts,oPublicKey,lastMessageReceived,receivedPackets,dataTransferWeights,dataTransferMaximumMOAttr,dataTransferMinimumMOAttr,dataTransferMOAttr,recievingCommWeights,recievingCommMOMaxAttr,recievingCommMOMinAttr,recievingCommMOAttr,maxTransmitBytes,transmitNum,maxTransmitSize,receiveConMessNumSend,sendConMessNumSend,receiveConMessNumReceive,sendConMessNumReceive,confirmReceiveNum,confirmSendNum,confirmReceiveOut,confirmSendOut,iLength,complete,senderMess,toTransmit,cAlgs,toSend,transmitting,received,cInit,rLength,recveing,receivedMessageBlock,receivedMessageBlocks,dCAlg,key,oPort,lastConTime,sRNumber,receiveNumber,prevReceiveNumber,prevSendNumber,sendNumber,numNeeded,oID,oIP,commSec}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
...
Object $_MANAGED_object_COMPILER_RETURN_VALUE_$=null;
        ...
        if(true)
        {
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483625,creator}, 1, -2146483609, true, true, new Object[]{protocolStrength,securityProtocol,mLen,mCont,port,iPv4,creator,dataCompression,lastReceivedTime,sendState,receiveState,receiveAttempts,sendAttempts,maxCommunicationAttempts,oPublicKey,lastMessageReceived,receivedPackets,dataTransferWeights,dataTransferMaximumMOAttr,dataTransferMinimumMOAttr,dataTransferMOAttr,recievingCommWeights,recievingCommMOMaxAttr,recievingCommMOMinAttr,recievingCommMOAttr,maxTransmitBytes,transmitNum,maxTransmitSize,receiveConMessNumSend,sendConMessNumSend,receiveConMessNumReceive,sendConMessNumReceive,confirmReceiveNum,confirmSendNum,confirmReceiveOut,confirmSendOut,iLength,complete,senderMess,toTransmit,cAlgs,toSend,transmitting,received,cInit,rLength,recveing,receivedMessageBlock,receivedMessageBlocks,dCAlg,key,oPort,lastConTime,sRNumber,receiveNumber,prevReceiveNumber,prevSendNumber,sendNumber,numNeeded,oID,oIP,commSec}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
            super.$_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$(creator, $_MANAGED_object_COMPILER_CALL_DATA_$, this);
;            return null;
        }
        if($_MANAGED_object_COMPILER_RETURN_VALUE_$ instanceof TimeOutObject)
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_24(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_162(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        if(!checkPermission(new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483627,$_MANAGED_object_COMPILER_RETURN_VALUE_$,$_MANAGED_object_COMPILER_RETURN_STATE_$,$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$},$_MANAGED_object_RETURN_MANAGED_OBJECT_$))
        {
    throw new MOPermissionDeniedException();
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object $_MANAGED_object_COMPILER_CONCURRENT_METHOD_receiveMessage_0_$_MANAGED_object_COMPILER_METHOD_257(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
$_MANAGED_object_COMPILER_DATA_$.setRunNumber(-2146483624);
        $_MANAGED_object_COMPILER_RETURN_VALUE_$=ManagedObjectUtilities.messAgree((Object[])$_MANAGED_object_COMPILER_RETURN_VALUE_$);
boolean $_MANAGED_object_COMPILER_FIRST_LOOP_$=true;
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object $_MANAGED_object_COMPILER_CONCURRENT_METHOD_readMessage_1_$_MANAGED_object_COMPILER_METHOD_260(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
$_MANAGED_object_COMPILER_DATA_$.setRunNumber(-2146483623);
        $_MANAGED_object_COMPILER_RETURN_VALUE_$=ManagedObjectUtilities.messAgree((Object[])$_MANAGED_object_COMPILER_RETURN_VALUE_$);
boolean $_MANAGED_object_COMPILER_FIRST_LOOP_$=true;
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_261(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        if(!checkPermission(new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483627,$_MANAGED_object_COMPILER_RETURN_VALUE_$,$_MANAGED_object_COMPILER_RETURN_STATE_$,$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$},$_MANAGED_object_RETURN_MANAGED_OBJECT_$))
        {
    throw new MOPermissionDeniedException();
...
ByteArrayWrapper oSID;
ManagedObject creator;
        matchingCommMOAttributesWeights=(int[])$_MANAGED_object_COMPILER_RETURN_STATE_$[0];
        matchingCommMOAttributes=(int[])$_MANAGED_object_COMPILER_RETURN_STATE_$[1];
        tempBy=(byte[])$_MANAGED_object_COMPILER_RETURN_STATE_$[2];
        commAttrs=(int[])$_MANAGED_object_COMPILER_RETURN_STATE_$[3];
        protocolStrength=(int)$_MANAGED_object_COMPILER_RETURN_STATE_$[4];
        securityProtocol=(String)$_MANAGED_object_COMPILER_RETURN_STATE_$[5];
        oSID=(ByteArrayWrapper)$_MANAGED_object_COMPILER_RETURN_STATE_$[6];
        creator=(ManagedObject)$_MANAGED_object_COMPILER_RETURN_STATE_$[7];
...
ByteArrayWrapper oSID;
ManagedObject creator;
        matchingCommMOAttributesWeights=(int[])$_MANAGED_object_COMPILER_RETURN_STATE_$[6];
        matchingCommMOAttributes=(int[])$_MANAGED_object_COMPILER_RETURN_STATE_$[7];
        tempBy=(byte[])$_MANAGED_object_COMPILER_RETURN_STATE_$[8];
        commAttrs=(int[])$_MANAGED_object_COMPILER_RETURN_STATE_$[9];
        protocolStrength=(int)$_MANAGED_object_COMPILER_RETURN_STATE_$[10];
        securityProtocol=(String)$_MANAGED_object_COMPILER_RETURN_STATE_$[11];
        oSID=(ByteArrayWrapper)$_MANAGED_object_COMPILER_RETURN_STATE_$[12];
        creator=(ManagedObject)$_MANAGED_object_COMPILER_RETURN_STATE_$[13];
Object[] oMess;
Node[] SIDMO;
int[] SIDMOWeights;
int[] maxSIDMOVals;
int[] minSIDMOVals;
int[] SIDMOAttrs;
        oMess=(Object[])$_MANAGED_object_COMPILER_RETURN_STATE_$[0];
        SIDMO=(Node[])$_MANAGED_object_COMPILER_RETURN_STATE_$[1];
        SIDMOWeights=(int[])$_MANAGED_object_COMPILER_RETURN_STATE_$[2];
        maxSIDMOVals=(int[])$_MANAGED_object_COMPILER_RETURN_STATE_$[3];
        minSIDMOVals=(int[])$_MANAGED_object_COMPILER_RETURN_STATE_$[4];
        SIDMOAttrs=(int[])$_MANAGED_object_COMPILER_RETURN_STATE_$[5];
            if($_MANAGED_object_COMPILER_FIRST_LOOP_$)
            {
Object $_MANAGED_object_COMPILER_VARIABLE_2_$=null;
                if($_MANAGED_object_COMPILER_FIRST_LOOP_$)
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    @$_MANAGED_OBJECT_COMPILER_ANNOTATION_$($_SEND_STOPPED_$=false, $_MANAGED_object_COMPILER_RUN_Number_$=-2146483611)
    private Object $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_310(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        if(!checkPermission(new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483627,$_MANAGED_object_COMPILER_RETURN_VALUE_$,$_MANAGED_object_COMPILER_RETURN_STATE_$,$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$},$_MANAGED_object_RETURN_MANAGED_OBJECT_$))
        {
    throw new MOPermissionDeniedException();
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    @$_MANAGED_OBJECT_COMPILER_ANNOTATION_$($_SEND_STOPPED_$=false, $_MANAGED_object_COMPILER_RUN_Number_$=-2146483610)
    private Object $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_320(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        if(!checkPermission(new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483627,$_MANAGED_object_COMPILER_RETURN_VALUE_$,$_MANAGED_object_COMPILER_RETURN_STATE_$,$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$},$_MANAGED_object_RETURN_MANAGED_OBJECT_$))
        {
    throw new MOPermissionDeniedException();
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    @$_MANAGED_OBJECT_COMPILER_ANNOTATION_$($_SEND_STOPPED_$=false, $_MANAGED_object_COMPILER_RUN_Number_$=-2146483609)
    private Object $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_321(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        if(!checkPermission(new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2146483625,$_MANAGED_object_COMPILER_RETURN_VALUE_$,$_MANAGED_object_COMPILER_RETURN_STATE_$,$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$},$_MANAGED_object_RETURN_MANAGED_OBJECT_$))
        {
    throw new MOPermissionDeniedException();
    ...
    public void MANAGED_object_COMPILER_RUN(Object[] message, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws Exception, MOPermissionDeniedException, TimeOutException
    {
        switch((int)message[3])
        {
            ...
            case -2146483623:
                ...
                break;
            case -2146483622:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_24((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483621:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_25((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483620:
                CommunicationManagedObject_MANAGED_object_COMPILER_METHOD_53((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483619:
                CommunicationManagedObject_MANAGED_object_COMPILER_METHOD_54((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483618:
                CommunicationManagedObject_MANAGED_object_COMPILER_METHOD_55((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483617:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_162((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483616:
                $_MANAGED_object_COMPILER_CONCURRENT_METHOD_receiveMessage_0_$_MANAGED_object_COMPILER_METHOD_257((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483615:
                $_MANAGED_object_COMPILER_CONCURRENT_METHOD_readMessage_1_$_MANAGED_object_COMPILER_METHOD_260((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483614:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_261((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483613:
            ...
            case -2146483612:
                ...
                break;
            case -2146483611:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_310((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483610:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_320((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2146483609:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_321((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            default:
