...
public class IntelligenceManagedObjectLatticeRemoveMOAttributes extends IntelligenceManagedObject

{

public static final byte[] $_MANAGED_object_COMPILER_CLASS_ID_$=new byte[]{-101, 78, -28, -22, -60, -58, -103, -67, 3, -30, 6, -2, 120, -109, 8, -44, -99, -32, 15, -19, -101, 61, -103, 10, -122, -28, -17, 0, -65, 110, 14, -107};
static final long serialVersionUID=-7255610252672460355L;
    ...
    public IntelligenceManagedObjectLatticeRemoveMOAttributes() throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
        }
        for(CompareMessage[] permission: HSystem.getDefaultPermission(IntelligenceManagedObjectLatticeRemoveMOAttributes.class))
        {
            addPermission(permission, null, this);
        }
    }
    ...
    public IntelligenceManagedObjectLatticeRemoveMOAttributes(Object[] targetMessage, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    public IntelligenceManagedObjectLatticeRemoveMOAttributes(ManagedObject creator, Object[] targetMessage, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
...
Object $_MANAGED_object_COMPILER_RETURN_VALUE_$=null;
            if(true)
            {
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2145483647, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2145483647,creator,targetMessage}, null, false}, 1, -2145483640, true, true, new Object[]{targetMessage,creator}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
...
@Override
    ...
    protected Object getIntelligenceMessage(Object[] message, ManagedObject runningManagedObject, Object[] result, boolean isResult, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        ...
        {
            return ((IntelligenceManagedObjectLatticeRemoveMOAttributes)getFirstLatticeManagedObject()).getIntelligenceMessage(message, runningManagedObject, result, isResult, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
        }
        else
        {
...
int[] attributes=new int[HSystem.mOAttributesLength];
                        System.arraycopy(((Node)message[4]).mO.getAttributesShell($_MANAGED_object_COMPILER_DATA_$, this), 0, attributes, 0, attributes.length);
Node[] matchingMO=null;
                        try
                        {
                            matchingMO=runningManagedObject.latticeSearchLocalMOLink(attributes, new int[0], new int[1], new int[0], 2, HSystem.defaultNumCheckNodes/20, false, $_MANAGED_object_COMPILER_DATA_$, this);
                        }
                        catch(MOPermissionDeniedException e)
                        {
                            e.printStackTrace();
                        }
                        if(matchingMO.length>1
 && matchingMO[0].distance[0]==0 && matchingMO[0].distance[1]==0
 && matchingMO[1].distance[0]==0 && matchingMO[1].distance[1]==0)
                        {
                            if(!$_MANAGED_object_COMPILER_DATA_$.isAggreagteThenCallDisabled())
                            {
Object[] $_MANAGED_object_COMPILER_RETURN_MESSAGE_$=new Object[]{$_MANAGED_object_COMPILER_DATA_$, this,$_MANAGED_object_RETURN_MANAGED_OBJECT_$,$_MANAGED_object_COMPILER_aggregateThenCall_Object$$_ByteArrayWrapper_ManagedObject_$, new Object[]{message, null, null,efficiencyChangePeriod}};
...
;                        return null;
    ...
    @MOCompilerControl(checkLink=false, checkShell=false, compile=false, checkCloned=false, checkPermission=false, intelligenceBefore=false, intelligenceAfter=false, aggregateReturn=false, timeEfficiency=false, offload=false)
    @$_MANAGED_OBJECT_COMPILER_ANNOTATION_$($_SEND_STOPPED_$=false, $_MANAGED_object_COMPILER_RUN_Number_$=2147483647)
    private IntelligenceManagedObjectLatticeRemoveMOAttributes($_MANAGED_object_COMPILER_DUMMY_VARIABLE_$ $_MANAGED_object_COMPILER_DUMMY_variable_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
    ...
    {
IntelligenceManagedObjectLatticeRemoveMOAttributes $_MANAGED_object_COMPILER_CREATED_Object_$=new IntelligenceManagedObjectLatticeRemoveMOAttributes(new $_MANAGED_object_COMPILER_DUMMY_VARIABLE_$());
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
...
;
    ...
    public IntelligenceManagedObjectLatticeRemoveMOAttributes $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$(Object[] targetMessage, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(IntelligenceManagedObjectLatticeRemoveMOAttributes.class))
        {
            addPermission(permission, null, this);
...
Object $_MANAGED_object_COMPILER_RETURN_VALUE_$=null;
        ...
        if(true)
        {
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2145483644,targetMessage}, 1, -2145483638, true, true, new Object[]{targetMessage}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
...
;
    ...
    public IntelligenceManagedObjectLatticeRemoveMOAttributes $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$(ManagedObject creator, Object[] targetMessage, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(IntelligenceManagedObjectLatticeRemoveMOAttributes.class))
        {
            addPermission(permission, null, this);
...
Object $_MANAGED_object_COMPILER_RETURN_VALUE_$=null;
        ...
        if(true)
        {
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2145483642,creator, targetMessage}, 1, -2145483637, true, true, new Object[]{targetMessage,creator}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private void IntelligenceManagedObjectLatticeRemoveMOAttributes_MANAGED_object_COMPILER_METHOD_135(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object getIntelligenceMessage_MANAGED_object_COMPILER_METHOD_249(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        if(mOAttributes==null && getFirstLatticeManagedObject()!=null)
        {
            return ((IntelligenceManagedObjectLatticeRemoveMOAttributes)getFirstLatticeManagedObject()).getIntelligenceMessage_MANAGED_object_COMPILER_METHOD_249($_MANAGED_object_COMPILER_RETURN_VALUE_$, $_MANAGED_object_COMPILER_RETURN_STATE_$, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
        }
        else
        {
...
Object $_MANAGED_object_COMPILER_VARIABLE_0_$=null;
    ...
    private Object $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_332(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_333(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
...
public static final int $_MANAGED_object_COMPILER_IntelligenceManagedObjectLatticeRemoveMOAttributes_$=2147483647;
public static final int $_MANAGED_object_COMPILER_IntelligenceManagedObjectLatticeRemoveMOAttributes_Object$$_ByteArrayWrapper_ManagedObject_$=-2145483648;
public static final int $_MANAGED_object_COMPILER_IntelligenceManagedObjectLatticeRemoveMOAttributes_ManagedObject_Object$$_ByteArrayWrapper_ManagedObject_$=-2145483647;
...
public static final int $_MANAGED_object_COMPILER_IntelligenceManagedObjectLatticeRemoveMOAttributes_$_MANAGED_object_COMPILER_DUMMY_VARIABLE_$_$=2147483647;
    ...
    public void MANAGED_object_COMPILER_RUN(Object[] message, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws Exception, MOPermissionDeniedException, TimeOutException
    {
        switch((int)message[3])
        {
            case -2145483646:
                ...
                break;
            case -2145483645:
                $_MANAGED_object_COMPILER_CREATE_METHOD_$((Object[])message[4], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483644:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$((Object[])message[4], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483643:
                $_MANAGED_object_COMPILER_CREATE_METHOD_$((ManagedObject)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483642:
                ...
                break;
            case -2145483641:
                IntelligenceManagedObjectLatticeRemoveMOAttributes_MANAGED_object_COMPILER_METHOD_135((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483640:
                IntelligenceManagedObjectLatticeRemoveMOAttributes_MANAGED_object_COMPILER_METHOD_136((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483639:
                getIntelligenceMessage_MANAGED_object_COMPILER_METHOD_249((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483638:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_332((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483637:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_333((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            default:
