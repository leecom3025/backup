...
public class TestMatrixOffload 
{
...
static final boolean master=true;
	...
	static void master() throws Exception
	{
		...
		MatrixObject.$_MANAGED_object_COMPILER_CREATE_METHOD_$(HSystem.mothreads[0], HSystem.SID, HSystem.mothreads[0]);
		Thread.sleep(2000);
	...
	static void client() throws Exception
	{
		...
		while(true)
		{
			((MatrixObject)HSystem.managedObjects.get(HSystem.managedObjects.size()-1)).multiplyRandomMatricesAndGetFNormTest(1000, new ByteArrayWrapper(), null);
			Thread.sleep(1000);
		}
	}
