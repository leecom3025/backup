...
public class IntelligenceManagedObjectLatticeSearch_24_25 extends IntelligenceManagedObject

{

public static final byte[] $_MANAGED_object_COMPILER_CLASS_ID_$=new byte[]{3, 76, -40, 78, 78, 120, -120, -25, -67, -58, -123, 84, -120, -34, -4, 62, 52, -120, -5, -52, -109, -43, 25, -26, -27, -42, -110, 46, -9, -128, 22, -104};
static final long serialVersionUID=237802711179364583L;
    ...
    public IntelligenceManagedObjectLatticeSearch_24_25() throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
        }
        for(CompareMessage[] permission: HSystem.getDefaultPermission(IntelligenceManagedObjectLatticeSearch_24_25.class))
        {
            addPermission(permission, null, this);
        }
    }
...
private int increaseSearchAmount=1000;
    
        @$_MANAGED_OBJECT_COMPILER_ANNOTATION_$($_SEND_STOPPED_$=true, $_MANAGED_object_COMPILER_RUN_Number_$=-2145483648)
    public IntelligenceManagedObjectLatticeSearch_24_25(Object[] targetMessage, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    public IntelligenceManagedObjectLatticeSearch_24_25(ManagedObject creator, Object[] targetMessage, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
...
Object $_MANAGED_object_COMPILER_RETURN_VALUE_$=null;
            if(true)
            {
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2145483647, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2145483647,creator,targetMessage}, null, false}, 1, -2145483640, true, true, new Object[]{targetMessage,creator,increaseSearchAmount}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
...
@Override
    ...
    protected Object getIntelligenceMessage(Object[] message, ManagedObject runningManagedObject, Object[] result, boolean isResult, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        ...
        {
            return ((IntelligenceManagedObjectLatticeSearch_24_25)getFirstLatticeManagedObject()).getIntelligenceMessage(message, runningManagedObject, result, isResult, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
        }
        else
        {
...
Object $_MANAGED_object_COMPILER_RETURN_VALUE_$=null;
                if(!cloned || $_MANAGED_object_COMPILER_DATA_$.isCloneRunDisabled())
                {
                    ...
                    if(isResult && ((int[])message[4]).length==HSystem.mOAttributesLength && ((int[])message[8]).length==0)
                    {
long[] totalDistance=new long[]{0, 0};
                        for(int returnedNodeNum=0; returnedNodeNum<((Node[])(result[4])).length; returnedNodeNum++)
                        {
                            totalDistance[0]+=((Node[])(result[4]))[returnedNodeNum].distance[0];
                            totalDistance[1]+=((Node[])(result[4]))[returnedNodeNum].distance[1];
                        }
                        if(((Node[])(result[4])).length<(int)message[message.length-3]
 || ((message[message.length-4] instanceof long[]
 && (totalDistance[1]/((Node[])(result[4])).length>((long[])message[message.length-4])[1]
 || ((totalDistance[1]/((Node[])(result[4])).length==((long[])message[message.length-4])[1])
 && ((totalDistance[0]/((Node[])(result[4])).length>((long[])message[message.length-4])[0])))))))
                        {
Object[] searchMessage=new Object[message.length];
                            System.arraycopy(message, 0, searchMessage, 0, searchMessage.length);
                            searchMessage[0]=result[0];
                            searchMessage[2]=HSystem.managedObjects.get((int)(Math.random()*HSystem.managedObjects.size()));
                            searchMessage[searchMessage.length-2]=(int)searchMessage[searchMessage.length-2]+increaseSearchAmount;
                            if(!$_MANAGED_object_COMPILER_DATA_$.isAggreagteThenCallDisabled())
                            {
Object[] $_MANAGED_object_COMPILER_RETURN_MESSAGE_$=new Object[]{$_MANAGED_object_COMPILER_DATA_$, this,$_MANAGED_object_RETURN_MANAGED_OBJECT_$,$_MANAGED_object_COMPILER_aggregateThenCall_Object$$_ByteArrayWrapper_ManagedObject_$, new Object[]{null, new Object[][]{searchMessage}, null,efficiencyChangePeriod}};
                                if($_MANAGED_object_COMPILER_DATA_$.sendToMOThread())
                                {
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
                                    if(!($_MANAGED_object_COMPILER_SEARCH_RESULT_$.length>0 && $_MANAGED_object_COMPILER_SEARCH_RESULT_$[0].mO instanceof MOThread))
...
;                        return null;
    ...
    @MOCompilerControl(checkLink=false, checkShell=false, compile=false, checkCloned=false, checkPermission=false, intelligenceBefore=false, intelligenceAfter=false, aggregateReturn=false, timeEfficiency=false, offload=false)
    @$_MANAGED_OBJECT_COMPILER_ANNOTATION_$($_SEND_STOPPED_$=false, $_MANAGED_object_COMPILER_RUN_Number_$=2147483647)
    private IntelligenceManagedObjectLatticeSearch_24_25($_MANAGED_object_COMPILER_DUMMY_VARIABLE_$ $_MANAGED_object_COMPILER_DUMMY_variable_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
    ...
    {
IntelligenceManagedObjectLatticeSearch_24_25 $_MANAGED_object_COMPILER_CREATED_Object_$=new IntelligenceManagedObjectLatticeSearch_24_25(new $_MANAGED_object_COMPILER_DUMMY_VARIABLE_$());
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
...
;
    ...
    public IntelligenceManagedObjectLatticeSearch_24_25 $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$(Object[] targetMessage, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(IntelligenceManagedObjectLatticeSearch_24_25.class))
        {
            addPermission(permission, null, this);
...
Object $_MANAGED_object_COMPILER_RETURN_VALUE_$=null;
        ...
        if(true)
        {
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2145483644,targetMessage}, 1, -2145483638, true, true, new Object[]{targetMessage,increaseSearchAmount}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
...
;
    ...
    public IntelligenceManagedObjectLatticeSearch_24_25 $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$(ManagedObject creator, Object[] targetMessage, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(IntelligenceManagedObjectLatticeSearch_24_25.class))
        {
            addPermission(permission, null, this);
...
Object $_MANAGED_object_COMPILER_RETURN_VALUE_$=null;
        ...
        if(true)
        {
ByteArrayWrapper $_MANAGED_object_COMPILER_CALL_DATA_$=addToAggregate($_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$, new Object[]{$_MANAGED_object_COMPILER_DATA_$,$_MANAGED_object_RETURN_MANAGED_OBJECT_$, this, -2145483642,creator,targetMessage}, 1, -2145483637, true, true, new Object[]{targetMessage,creator,increaseSearchAmount}, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private void IntelligenceManagedObjectLatticeSearch_24_25_MANAGED_object_COMPILER_METHOD_113(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object getIntelligenceMessage_MANAGED_object_COMPILER_METHOD_227(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        if(mOAttributes==null && getFirstLatticeManagedObject()!=null)
        {
            return ((IntelligenceManagedObjectLatticeSearch_24_25)getFirstLatticeManagedObject()).getIntelligenceMessage_MANAGED_object_COMPILER_METHOD_227($_MANAGED_object_COMPILER_RETURN_VALUE_$, $_MANAGED_object_COMPILER_RETURN_STATE_$, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
        }
        else
        {
...
public static final int $_MANAGED_object_COMPILER_IntelligenceManagedObjectLatticeSearch_24_25_$=2147483647;
public static final int $_MANAGED_object_COMPILER_IntelligenceManagedObjectLatticeSearch_24_25_Object$$_ByteArrayWrapper_ManagedObject_$=-2145483648;
public static final int $_MANAGED_object_COMPILER_IntelligenceManagedObjectLatticeSearch_24_25_ManagedObject_Object$$_ByteArrayWrapper_ManagedObject_$=-2145483647;
...
public static final int $_MANAGED_object_COMPILER_IntelligenceManagedObjectLatticeSearch_24_25_$_MANAGED_object_COMPILER_DUMMY_VARIABLE_$_$=2147483647;
    ...
    public void MANAGED_object_COMPILER_RUN(Object[] message, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        switch((int)message[3])
        {
            case -2145483646:
                ...
                break;
            case -2145483641:
                IntelligenceManagedObjectLatticeSearch_24_25_MANAGED_object_COMPILER_METHOD_113((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483640:
                IntelligenceManagedObjectLatticeSearch_24_25_MANAGED_object_COMPILER_METHOD_114((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483639:
                getIntelligenceMessage_MANAGED_object_COMPILER_METHOD_227((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483638:
                ...
                break;
            case -2145483637:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_264((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            default:
