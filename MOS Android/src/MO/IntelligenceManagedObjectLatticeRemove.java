...
public class IntelligenceManagedObjectLatticeRemove extends IntelligenceManagedObject

{

public static final byte[] $_MANAGED_object_COMPILER_CLASS_ID_$=new byte[]{81, 70, 55, -76, 103, -31, -106, 127, 84, 120, 30, -11, -52, -29, 115, 73, -52, -40, 113, -10, 82, -68, -80, -111, 36, 36, 113, -45, 69, 72, -48, -81};
static final long serialVersionUID=5856429613418387071L;
    ...
    public IntelligenceManagedObjectLatticeRemove() throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
        }
        for(CompareMessage[] permission: HSystem.getDefaultPermission(IntelligenceManagedObjectLatticeRemove.class))
        {
            addPermission(permission, null, this);
        }
    }
    ...
    public IntelligenceManagedObjectLatticeRemove(Object[] targetMessage, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    public IntelligenceManagedObjectLatticeRemove(ManagedObject creator, Object[] targetMessage, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
...
@Override
    ...
    protected Object getIntelligenceMessage(Object[] message, ManagedObject runningManagedObject, Object[] result, boolean isResult, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        ...
        {
            return ((IntelligenceManagedObjectLatticeRemove)getFirstLatticeManagedObject()).getIntelligenceMessage(message, runningManagedObject, result, isResult, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
        }
        else
        {
...
Node[] matchingMO=null;
                        try
                        {
                            matchingMO=runningManagedObject.latticeSearchLocalMOLink(((Node)message[4]).mO.getAttributesShell($_MANAGED_object_COMPILER_DATA_$, this), new int[0], new int[0], weights, 2, HSystem.defaultNumCheckNodes/5, false, $_MANAGED_object_COMPILER_DATA_$, this);
                        }
...
;                        return null;
    ...
    @MOCompilerControl(checkLink=false, checkShell=false, compile=false, checkCloned=false, checkPermission=false, intelligenceBefore=false, intelligenceAfter=false, aggregateReturn=false, timeEfficiency=false, offload=false)
    @$_MANAGED_OBJECT_COMPILER_ANNOTATION_$($_SEND_STOPPED_$=false, $_MANAGED_object_COMPILER_RUN_Number_$=2147483647)
    private IntelligenceManagedObjectLatticeRemove($_MANAGED_object_COMPILER_DUMMY_VARIABLE_$ $_MANAGED_object_COMPILER_DUMMY_variable_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
            addPermission(permission, null, this);
    ...
    {
IntelligenceManagedObjectLatticeRemove $_MANAGED_object_COMPILER_CREATED_Object_$=new IntelligenceManagedObjectLatticeRemove(new $_MANAGED_object_COMPILER_DUMMY_VARIABLE_$());
        for(CompareMessage[] permission: HSystem.getDefaultPermission(ManagedObject.class))
        {
...
;
    ...
    public IntelligenceManagedObjectLatticeRemove $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$(Object[] targetMessage, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(IntelligenceManagedObjectLatticeRemove.class))
        {
            addPermission(permission, null, this);
...
;
    ...
    public IntelligenceManagedObjectLatticeRemove $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$(ManagedObject creator, Object[] targetMessage, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
        for(CompareMessage[] permission: HSystem.getDefaultPermission(IntelligenceManagedObjectLatticeRemove.class))
        {
            addPermission(permission, null, this);
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private void IntelligenceManagedObjectLatticeRemove_MANAGED_object_COMPILER_METHOD_90(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
...
Node[] $_MANAGED_object_COMPILER_SEARCH_RESULT_$=latticeSearchLocalMOThread(1, HSystem.mOThreadMaxSearches, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_COMPILER_DATA_$, this);
    ...
    private Object getIntelligenceMessage_MANAGED_object_COMPILER_METHOD_244(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws TimeOutException, MOPermissionDeniedException
    {
        if(mOAttributes==null && getFirstLatticeManagedObject()!=null)
        {
            return ((IntelligenceManagedObjectLatticeRemove)getFirstLatticeManagedObject()).getIntelligenceMessage_MANAGED_object_COMPILER_METHOD_244($_MANAGED_object_COMPILER_RETURN_VALUE_$, $_MANAGED_object_COMPILER_RETURN_STATE_$, $_MANAGED_object_COMPILER_DATA_$, $_MANAGED_object_RETURN_MANAGED_OBJECT_$);
        }
        else
        {
...
Object $_MANAGED_object_COMPILER_VARIABLE_0_$=null;
    ...
    private Object $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_327(Object $_MANAGED_object_COMPILER_RETURN_VALUE_$, Object[] $_MANAGED_object_COMPILER_RETURN_STATE_$, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws MOPermissionDeniedException, TimeOutException
    {
...
public static final int $_MANAGED_object_COMPILER_IntelligenceManagedObjectLatticeRemove_$=2147483647;
public static final int $_MANAGED_object_COMPILER_IntelligenceManagedObjectLatticeRemove_Object$$_ByteArrayWrapper_ManagedObject_$=-2145483648;
public static final int $_MANAGED_object_COMPILER_IntelligenceManagedObjectLatticeRemove_ManagedObject_Object$$_ByteArrayWrapper_ManagedObject_$=-2145483647;
...
public static final int $_MANAGED_object_COMPILER_IntelligenceManagedObjectLatticeRemove_$_MANAGED_object_COMPILER_DUMMY_VARIABLE_$_$=2147483647;
    ...
    public void MANAGED_object_COMPILER_RUN(Object[] message, ByteArrayWrapper $_MANAGED_object_COMPILER_DATA_$, ManagedObject $_MANAGED_object_RETURN_MANAGED_OBJECT_$) throws Exception, MOPermissionDeniedException, TimeOutException
    {
        switch((int)message[3])
        {
            ...
            case -2145483642:
                ...
                break;
            case -2145483641:
                IntelligenceManagedObjectLatticeRemove_MANAGED_object_COMPILER_METHOD_89((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483640:
                IntelligenceManagedObjectLatticeRemove_MANAGED_object_COMPILER_METHOD_90((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483639:
                getIntelligenceMessage_MANAGED_object_COMPILER_METHOD_244((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483638:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_327((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            case -2145483637:
                $_MANAGED_object_COMPILER_CONSTRUCTOR_METHOD_$_MANAGED_object_COMPILER_METHOD_328((Object)message[4], (Object[])message[5], (ByteArrayWrapper)message[0], (ManagedObject)message[1]);
                break;
            default:
